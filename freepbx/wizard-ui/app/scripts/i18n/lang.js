...
(function() {
  'use strict';
    ...
    var getAllLanguagesKey = function() {
        return isoLangs;
    };
    var getAllSupportedLanguagesKey = function() {
        return supportedLang;
    };
	window.getLanguageName = getLanguageName;
	window.getLanguageNativeName = getLanguageNativeName;
    window.getAllLanguagesKey = getAllLanguagesKey;
    window.getAllSupportedLanguagesKey = getAllSupportedLanguagesKey;
})();