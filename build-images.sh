...
buildah config \
    ...
    --label="org.nethserver.tcp-ports-demand=12" \
    --label="org.nethserver.rootfull=0" \
    --label="org.nethserver.images=$repobase/nethvoice-mariadb:${IMAGETAG:-latest} \
        $repobase/nethvoice-freepbx:${IMAGETAG:-latest} \
        $repobase/nethvoice-asterisk:${IMAGETAG:-latest} \
        $repobase/nethvoice-cti-server:${IMAGETAG:-latest} \
        $repobase/nethvoice-cti-ui:${IMAGETAG:-latest} \
        $repobase/nethvoice-tancredi:${IMAGETAG:-latest} \
        $repobase/nethvoice-janus:${IMAGETAG:-latest} \
        $repobase/nethvoice-phonebook:${IMAGETAG:-latest} \
        docker.io/library/redis:7.0.10-alpine \
        $repobase/nethvoice-reports-ui:${IMAGETAG:-latest} \
        $repobase/nethvoice-reports-api:${IMAGETAG:-latest}" \
    --entrypoint=/ \
    "${container}"
